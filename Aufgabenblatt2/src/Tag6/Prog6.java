...
public class Prog6 { //Es darf pro Datei nur eine public class geben
	...
	public static void main(String[] args) { //Der Zugriffsmodifizierer public bedeutet, dass die Methode in Ihrem Programm überall verwendet 
		...
		new MeinFenster6();		//Ich rufe jetzt mein  kreirtes Fenster auf. Ein Konstruktor erzeugt immer ein neues Objekt.
